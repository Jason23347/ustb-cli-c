...
set(STAGING_DIR "${OPENWRT_ROOT}/staging_dir")
set(ENV{STAGING_DIR} "${STAGING_DIR}")

set(TOOLCHAIN_DIR "${STAGING_DIR}/toolchain-aarch64_generic_gcc-13.3.0_musl")
set(TARGET_DIR "${STAGING_DIR}/target-aarch64_cortex-a53_musl")
